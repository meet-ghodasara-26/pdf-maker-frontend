...
const Toast = ({ toast }) => {
  ...
  return (
    <div
      className="toast"
      style={{ "--toast-color": colors[toast.type] || "#4a6cf7" }}
    >
    ...
    >
      ...
      <div className="dropzone-inner">
        ...
        <p className="dropzone-sub">
          or <span className="link">browse files</span>
        </p>
        ...
        <li key={item.id} className="history-item">
          ...
          <div className="history-info">
            ...
            <p className="history-time">
              {item.convertedAt} · {formatSize(item.size)}
            </p>
          </div>
          <button
            className="btn-icon btn-download"
    ...
    <div className={`app theme-${theme}`}>
      ...
      <header className="header">
        ...
        <nav className="header-nav">
          <button
            className={`nav-tab ${tab === "convert" ? "active" : ""}`}
          ...
          <>
            ...
            <div className="hero">
              <h1 className="hero-title">
                Convert anything
                <br />
                <span className="accent">to PDF</span>
              </h1>
              <p className="hero-sub">
                Images, Word, Excel, PowerPoint, HTML, Text — all formats, one
                click.
              </p>
            </div>
            ...
            {files.length === 0 && (
              <div className="formats-strip">
                {[
                  ...
                  <div key={f} className="format-pill">
                    {f}
                  </div>
                ))}
              </div>
